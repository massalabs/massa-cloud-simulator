...
# staking_setup = {srv["staking_address"]: {"secret_key": srv["staking_privkey"], "public_key": srv["staking_pubkey"]}}
    ...
    # Write node_keypair to JSON file
    data = {
        "secret_key": scrt_key,
        "public_key": pub_key
    }

    file_path = f"/home/arshavee/Desktop/MASSA internship/massa-cloud-simulator-main/config/node_keypair_{i+1}.key"
    ...
    file_path_staking = f"/home/arshavee/Desktop/MASSA internship/massa-cloud-simulator-main/config/staking_wallet_{i+1}.dat"
    ...
    # Load the JSON file
    with open('/home/arshavee/Desktop/MASSA internship/massa-cloud-simulator-main/config/initial_rolls.json', 'r') as file:
        data = json.load(file)
    ...
    with open('/home/arshavee/Desktop/MASSA internship/massa-cloud-simulator-main/config/initial_rolls.json', 'w') as file:
